...
public static class Constants
{
    ...
    public const string SubsysControlSemanalUrl = $"{BaseUrl}/padrescontrolsemanal";
    public const string SubsysCartasRecibidasUrl = $"{BaseUrl}/padrescontrolCartas";
    public const string SubsysCircularesUrl = $"{BaseUrl}/padrescontrolCirculares";
    ...
    public const string SubsysLicencias_LicenciaEnviaUrl = $"{SubsysLicenciasUrl}/licencia_envia.php"; // TODO: This is not used, but it SHOULD BE used in the future
}
